...
#    Apr 20, 2020 02:53:26 PM +06  platform: Windows NT
...
import employee_support

def vp_start_gui(id,name):
    '''Starting point when module is the main routine.'''
    global val, w, root
    root = tk.Tk()
    top = Employee (id,name,root)
    employee_support.init(root, top)
    root.mainloop()

w = None
def create_Employee(rt, *args, **kwargs):
    '''Starting point when module is imported by another module.
       Correct form of call: 'create_Employee(root, *args, **kwargs)' .'''
    global w, w_win, root
    #rt = root
    root = rt
    w = tk.Toplevel (root)
...
class Employee:
    def __init__(self, id, name, top=None):
        ...
        self.TNotebook1.tab(0, text="Taken orders", compound="left"
                ,underline="-1", )
        self.TNotebook1_t2_1.configure(background="#808080")
        self.TNotebook1_t2_1.configure(highlightbackground="#d9d9d9")
        self.TNotebook1_t2_1.configure(highlightcolor="black")
        self.TNotebook1_t3_5 = tk.Frame(self.TNotebook1)
        self.TNotebook1.add(self.TNotebook1_t3_5, padding=3)
        self.TNotebook1.tab(1, text="Orders",compound="none",underline="-1",)
        self.TNotebook1_t3_5.configure(background="#808080")
        self.TNotebook1_t3_5.configure(highlightbackground="#d9d9d9")
        self.TNotebook1_t3_5.configure(highlightcolor="black")

        self.Scrolledlistbox1_search = ScrolledListBox(self.TNotebook1_t2_1)
        ...
        self.from1_en = tk.Entry(self.TNotebook1_t2_1)
        ...
        self.Label3_2 = tk.Label(self.TNotebook1_t2_1)
        self.Label3_2.place(relx=0.033, rely=0.13, height=21, width=64)
        ...
        self.Label3_2.configure(text='''From''')

        self.where1_en = tk.Entry(self.TNotebook1_t2_1)
        ...
        self.Label4_3 = tk.Label(self.TNotebook1_t2_1)
        self.Label4_3.place(relx=0.033, rely=0.234, height=21, width=64)
        ...
        self.Label4_3.configure(text='''Where''')

        self.type1_en = tk.Entry(self.TNotebook1_t2_1)
        ...
        self.Label5_4 = tk.Label(self.TNotebook1_t2_1)
        self.Label5_4.place(relx=0.017, rely=0.339, height=31, width=84)
        ...
        self.Label5_4.configure(text='''Type of cargo''')

        self.Scrolledlistbox1_result = ScrolledListBox(self.TNotebook1_t2_1)
        ...
        self.from2_en = tk.Entry(self.TNotebook1_t3_5)
        self.from2_en.place(relx=0.167, rely=0.104,height=20, relwidth=0.257)
        ...
        self.where2_en = tk.Entry(self.TNotebook1_t3_5)
        ...
        self.type2_en = tk.Entry(self.TNotebook1_t3_5)
        ...
        self.Label6 = tk.Label(self.TNotebook1_t3_5)
        ...
        self.Label7 = tk.Label(self.TNotebook1_t3_5)
        ...
        self.Label8 = tk.Label(self.TNotebook1_t3_5)
        ...
        self.Scrolledlistbox2_search = ScrolledListBox(self.TNotebook1_t3_5)
        self.Scrolledlistbox2_search.place(relx=0.03, rely=0.417, relheight=0.482
                , relwidth=0.418)
        ...
        self.Scrolledlistbox2_result = ScrolledListBox(self.TNotebook1_t3_5)
        self.Scrolledlistbox2_result.place(relx=0.5, rely=0.052, relheight=0.846
                , relwidth=0.452)
        self.Scrolledlistbox2_result.configure(background="white")
        self.Scrolledlistbox2_result.configure(cursor="xterm")
        self.Scrolledlistbox2_result.configure(disabledforeground="#a3a3a3")
        self.Scrolledlistbox2_result.configure(font="TkFixedFont")
        self.Scrolledlistbox2_result.configure(foreground="black")
        self.Scrolledlistbox2_result.configure(highlightbackground="#d9d9d9")
        self.Scrolledlistbox2_result.configure(highlightcolor="#d9d9d9")
        self.Scrolledlistbox2_result.configure(selectbackground="#c4c4c4")
        self.Scrolledlistbox2_result.configure(selectforeground="black")

        self.menubar = tk.Menu(top,font="TkMenuFont",bg='#000000',fg=_fgcolor)
        top.configure(menu = self.menubar)

        self.name_lbl = tk.Label(top)
        self.name_lbl.place(relx=0.0, rely=0.022, height=21, width=145)
        ...
        self.log_out_btn = tk.Button(top)
        self.log_out_btn.place(relx=0.817, rely=0.022, height=24, width=52)
        self.log_out_btn.configure(activebackground="#ececec")
        self.log_out_btn.configure(activeforeground="#000000")
        self.log_out_btn.configure(background="#000000")
        ...
        self.log_out_btn.configure(command = lambda: log_out(top))
        ...
        self.Label2.configure(text='''Employee mode''')
