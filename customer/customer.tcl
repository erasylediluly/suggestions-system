...
#  Apr 20, 2020 02:49:16 PM +06  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top43 {base} {
    ...
    wm geometry $top 605x450+359+165
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    wm deiconify $top
    wm title $top "Customer"
    vTcl:DefineAlias "$top" "Customer" vTcl:Toplevel:WidgetProc "" 1
    set vTcl(real_top) {}
    vTcl:withBusyCursor {
    ...
    vTcl:DefineAlias "$top.tNo52" "TNotebook1" vTcl:WidgetProc "Customer" 1
    frame $top.tNo52.t1 \
        -background #808080 -highlightbackground $vTcl(actual_gui_bg) \
        -highlightcolor black 
    vTcl:DefineAlias "$top.tNo52.t1" "TNotebook1_t2" vTcl:WidgetProc "Customer" 1
    $top.tNo52 add $top.tNo52.t1 \
        -padding 0 -sticky nsew -state normal -text {Your orders} -image {} \
    ...
    vTcl::widgets::ttk::scrolledlistbox::CreateCmd $site_4_0.scr60 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 125 
    vTcl:DefineAlias "$site_4_0.scr60" "Scrolledlistbox1_search" vTcl:WidgetProc "Customer" 1
    ...
    vTcl:DefineAlias "$site_4_0.ent67" "from1_en" vTcl:WidgetProc "Customer" 1
    label $site_4_0.lab68 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text From 
    vTcl:DefineAlias "$site_4_0.lab68" "Label3" vTcl:WidgetProc "Customer" 1
    entry $site_4_0.ent69 \
        ...
        -insertbackground black -selectbackground #c4c4c4 \
        -selectforeground black -width 134 
    vTcl:DefineAlias "$site_4_0.ent69" "where1_en" vTcl:WidgetProc "Customer" 1
    label $site_4_0.lab70 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text Where 
    vTcl:DefineAlias "$site_4_0.lab70" "Label4" vTcl:WidgetProc "Customer" 1
    entry $site_4_0.ent71 \
        ...
        -insertbackground black -selectbackground #c4c4c4 \
        -selectforeground black -width 134 
    vTcl:DefineAlias "$site_4_0.ent71" "type1_en" vTcl:WidgetProc "Customer" 1
    label $site_4_0.lab72 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text {Type of cargo} 
    vTcl:DefineAlias "$site_4_0.lab72" "Label5" vTcl:WidgetProc "Customer" 1
    vTcl::widgets::ttk::scrolledlistbox::CreateCmd $site_4_0.scr82 \
        -background $vTcl(actual_gui_bg) -height 75 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 125 
    vTcl:DefineAlias "$site_4_0.scr82" "Scrolledlistbox1_result" vTcl:WidgetProc "Customer" 1
    ...
    frame $top.tNo52.t2 \
        -background #808080 -highlightbackground $vTcl(actual_gui_bg) \
        -highlightcolor black 
    vTcl:DefineAlias "$top.tNo52.t2" "TNotebook1_t3" vTcl:WidgetProc "Customer" 1
    $top.tNo52 add $top.tNo52.t2 \
        -padding 0 -sticky nsew -state normal -text {Make order} -image {} \
    ...
    vTcl:DefineAlias "$site_4_1.ent74" "from2_en" vTcl:WidgetProc "Customer" 1
    entry $site_4_1.ent75 \
        ...
        -insertbackground black -selectbackground #c4c4c4 \
        -selectforeground black -width 154 
    vTcl:DefineAlias "$site_4_1.ent75" "where2_en" vTcl:WidgetProc "Customer" 1
    entry $site_4_1.ent76 \
        ...
        -insertbackground black -selectbackground #c4c4c4 \
        -selectforeground black -width 154 
    vTcl:DefineAlias "$site_4_1.ent76" "type2_en" vTcl:WidgetProc "Customer" 1
    label $site_4_1.lab77 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text From 
    vTcl:DefineAlias "$site_4_1.lab77" "Label6" vTcl:WidgetProc "Customer" 1
    label $site_4_1.lab78 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text Where 
    vTcl:DefineAlias "$site_4_1.lab78" "Label7" vTcl:WidgetProc "Customer" 1
    label $site_4_1.lab79 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text {Type of cargo} 
    vTcl:DefineAlias "$site_4_1.lab79" "Label8" vTcl:WidgetProc "Customer" 1
    vTcl::widgets::ttk::scrolledlistbox::CreateCmd $site_4_1.scr81 \
        -background $vTcl(actual_gui_bg) -height 75 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 125 
    vTcl:DefineAlias "$site_4_1.scr81" "Scrolledlistbox2_search" vTcl:WidgetProc "Customer" 1
    ...
    button $site_4_1.but44 \
        ...
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text {Make an order} 
    vTcl:DefineAlias "$site_4_1.but44" "Make_btn" vTcl:WidgetProc "Customer" 1
    place $site_4_1.ent74 \
        -in $site_4_1 -x 0 -relx 0.183 -y 0 -rely 0.104 -width 154 \
        -relwidth 0 -height 20 -relheight 0 -anchor nw -bordermode ignore 
    ...
    place $site_4_1.but44 \
        -in $site_4_1 -x 0 -relx 0.067 -y 0 -rely 0.599 -width 187 \
    ...
    vTcl:DefineAlias "$top.lab54" "Name_lbl" vTcl:WidgetProc "Customer" 1
    button $top.but55 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
    ...
    vTcl:DefineAlias "$top.but55" "log_out_cus" vTcl:WidgetProc "Customer" 1
    label $top.lab56 \
        -activebackground #f9f9f9 -activeforeground black -background #000000 \
        -disabledforeground #a3a3a3 -font TkDefaultFont -foreground #ffffff \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text {Customer mode} 
    vTcl:DefineAlias "$top.lab56" "Label2" vTcl:WidgetProc "Customer" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.tNo52 \
    ...
    place $top.but55 \
        -in $top -x 0 -relx 0.826 -y 0 -rely 0.022 -anchor nw \
        -bordermode ignore 
    place $top.lab56 \
